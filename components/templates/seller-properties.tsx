...
export default function SellerProperties() {
  ...
  return (
    <div className="flex flex-col gap-8">
        ...
        <div className="flex items-start gap-3">
          ...
          <div>
            ...
            <p className="mt-1 text-sm text-muted-foreground">
              Manage properties you&apos;ve published. Search within the current
              page of results.
            </p>
          </div>
        </div>
      ...
      <div className="flex flex-col gap-4 rounded-xl border border-border/80 bg-card p-4 shadow-sm">
        {/* Search Input */}
